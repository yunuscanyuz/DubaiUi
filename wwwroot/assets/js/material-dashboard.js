...
function showError(input, message) {
  ...
  formControl.className =
    "input-group input-group-outline input-group-static input-group-sm mb-3 is-invalid is-filled";
...
function showSucces(input) {
  const formControl = input.parentElement;
  formControl.className =
    "input-group input-group-outline input-group-static input-group-sm is-valid is-filled";
}
